...
function addList() {
    ...
    str += "<tr>";
    str += "<td class='dev-name fixed edit-td' title='" + $("#devname").val() + "'><span class='dev-name-txt'>" + ($("#devname").val() || "") + "</span><img class='edit-btn edit-btn-txt-append' src='img/edit.png' /></td>";
...
function initValue(obj) {
    ...
    for (i = 0; i < dhcpClientArray.length; i++) {
        str += "<tr>";
        str += "<td class='dev-name fixed edit-td' title='" + dhcpClientArray[i].devname + "'><span class='dev-name-txt'>" + (dhcpClientArray[i].devname || "") + "</span><img class='edit-btn edit-btn-txt-append' src='img/edit.png' /></td>";
    ...
    for (j = 0; j < bindArray.length; j++) {
        str += "<tr>";
        str += "<td class='dev-name fixed edit-td' title='" + bindArray[j].devname + "'><span class='dev-name-txt'>" + (bindArray[j].devname || "") + "</span><img class='edit-btn edit-btn-txt-append' src='img/edit.png' /></td>";

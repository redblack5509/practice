...
function initValue(obj) {
	...
	if (obj.wl_mode != "ap" || obj.wl_en == "0") {
		if (obj.wl_mode != "ap")
		showErrMsg("msg-err", _("The WPS feature is not available while the Wireless Repeating is enabled. Please go to Wireless Settings part to disable the Wireless Repeating first."), true);
		if (obj.wl_en == "0")

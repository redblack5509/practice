...
staInfo = {
    ...
    setUSB: function (obj) {
        ...
        if (obj.hasusb === "0") {
            $('.usb-line').css("background", "url(../img/usb_line_gray.png?27200cb68ff52ca7d537fbfe8ef08dd2)");
            $('.usb').css("background", "url(../img/usb_gray.png?ab1ba0cd2ee0625aeb5810ae9882bb1a)");
            $('#status_usb_txt').removeClass("none");
            $('.status-usb').css("cursor", "default");
            $('.usb').css("cursor", "default");
        } else {
            $('.usb-line').css("background", "url(../img/usb_line.png?d01cadb4ba82da3839a72f43e57057a8)");
            $('.usb').css("background", "url(../img/usb.png?da395180ca947dcd796fef3b27664617)");

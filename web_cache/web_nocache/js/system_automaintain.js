...
function initValue(obj) {
	...
	$("#autoTip").html(_("When this feature is enabled, the router will automatically reboot and maintain itself during %s each day, once traffic drops below %s KB/s.", ["03:00~05:00", obj.speed]));
	top.initIframeHeight();
}

/*
    编译方法：gcc *.c 
    realtek交叉编译不过，缺少头文件，据我观察，缺少两个头文件，硬要编可以指定到
    博通的openssl头文件目录来编
*/
...
/* 
    用例:
./a.out -e 123 12345678
./a.out -e 123 1234567890
./a.out -e 0 1234567890
./a.out -e 123456781234567812345678 1234567890
./a.out -e 123456781234567812345678 12345678901234567890154567897897
./a.out -e 1234567812345678 12345678901234567890154567897897
./a.out -e 1234567812345678 1234567812345678
*/
